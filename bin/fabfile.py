...
env.hosts = ['research.example.com']
env.code_dir = '/srv/www/research'
env.virtualenv = '/srv/www/research/.virtualenv'
env.code_repo = 'git@github.com:user/research.git'
env.django_settings_module = 'research.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/research/wsgi.py" % env.code_dir)
